      ...
      <div className="w-full max-w-4xl px-4 mx-auto z-10 relative text-center">
        ...
        <div className="max-w-2xl mx-auto relative group">
          <a
            ...
            className="text-xl sm:text-2xl md:text-3xl text-white font-thin tracking-wide hover:text-sky-400 transition-colors duration-300 break-all underline decoration-1 underline-offset-8 decoration-sky-400/30"
          >
