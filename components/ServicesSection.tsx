  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex-1 flex flex-col">
        ...
        <a href="https://wa.me/542364329720" target="_blank" rel="noopener noreferrer" className={`mt-8 flex items-center text-sky-400 font-mono text-xs tracking-widest uppercase transition-all duration-500 ${
