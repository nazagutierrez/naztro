...
export function CTASection() {
  ...
  return (
    <section className="py-12 w-full my-24 flex justify-center items-center px-4 md:px-6">
      <div 
        className="w-full mx-20 relative"
        onMouseEnter={() => setIsHovered(true)}
        onMouseLeave={() => setIsHovered(false)}
      >
        <div className="relative overflow-hidden rounded-[48px] border border-sky-700 shadow-sm min-h-[600px] md:min-h-[700px] flex flex-col items-center justify-center duration-500">
          ...
          <div className="relative z-10 px-6 max-w-4xl mx-auto text-center flex flex-col items-center">
            ...
            {/* Headline */}
            <h2 className="font-serif flex flex-col gap-y-5 text-6xl md:text-8xl lg:text-9xl font-medium tracking-tight text-foreground mb-10 leading-[1.05]">
              <span className="main-font">NAZTRO </span>
              <span className="text-6xl">digitalizamos tu <span className="hero-font">negocio.</span></span>
            </h2>
